          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit(data => addMutation.mutate(data))} className="space-y-3">
              ...
              {Object.keys(errors).length > 0 && (
                <p className="text-xs text-red-500">Vui lòng điền đầy đủ thông tin</p>
              )}
              <Button
                type="submit"
            ...
            <div key={addr.id} className="bg-white rounded-lg p-4 shadow-sm flex gap-4 items-start">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  {addr.isDefault && (
                    <Badge className="bg-emerald-100 text-emerald-700 text-xs">Mặc định</Badge>
                  )}
                </div>
              ...
              <button
                onClick={() => removeMutation.mutate(addr.id)}
