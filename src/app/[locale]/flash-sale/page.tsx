    ...
    <div className="max-w-6xl mx-auto py-8 px-4 space-y-8">
      ...
      >
        <div className="space-y-2 text-center sm:text-left">
          ...
          <h1 className="font-editorial font-black text-4xl sm:text-5xl tracking-tight text-white">
            Flash Sale
          </h1>
          {session && <p className="text-white/50 text-sm">{session.name}</p>}
        </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-24 space-y-3">
          ...
          <p className="text-muted-foreground text-sm">
            Hãy quay lại vào thời gian Flash Sale để săn hàng giá tốt nhé!
          </p>
          <Link href="/products">
