      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            {product.stock > 0 ? (
              <span className="text-[var(--fresh)] font-semibold">
          ...
          {product.stock > 0 ? (
            <div className="flex items-center gap-4">
              <div className="flex items-center border border-border rounded-lg overflow-hidden">
                ...
                <span className="px-5 py-2.5 font-bold text-base min-w-[3rem] text-center border-x border-border">
                  {quantity}
                </span>
                <button
                  type="button"
          ...
          <div className="grid grid-cols-3 gap-3 pt-2">
            {[
              ...
              <div
                key={label}
                className="text-center p-3 bg-muted border border-border/60 rounded-xl"
              >
                ...
                return (
                  <div key={star} className="flex items-center gap-2">
                    ...
                    <div className="flex-1 bg-border/40 rounded-full h-1.5 overflow-hidden">
                      <div
                        className="bg-[var(--amber)] h-full rounded-full"
                        style={{ width: `${pct}%` }}
                      />
                    </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map(s => (
                  ...
                  >
                    <Star
                      className={`h-8 w-8 ${s <= rating ? 'fill-[var(--amber)] text-[var(--amber)]' : 'text-border hover:text-[var(--amber)]/50'}`}
                    />
                  </button>
                ))}
