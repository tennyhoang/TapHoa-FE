    ...
    <div className={`relative rounded-xl overflow-hidden bg-gradient-to-r ${gradient} my-2`}>
      <div className="flex items-center justify-between px-8 py-8">
        <div className="text-white z-10">
          ...
          {sub && <p className="text-white/80 text-sm mb-5">{sub}</p>}
          <Link
            href={href}
            className="inline-flex items-center gap-1.5 bg-white text-orange-700 font-bold px-6 py-2.5 rounded-full text-sm hover:bg-orange-50 transition-colors shadow-sm"
          >
